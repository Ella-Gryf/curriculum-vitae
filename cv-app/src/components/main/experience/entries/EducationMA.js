        ...
        <div className='grid-row'>
          <div className='text-content'>
            ...
            <p>
              ...
              abroad in Boston. I <span className='bold'>majored in 
            ...
            <p>
              ...
              and the philosophy of quantum mechanics and special relativity. 
            </p>
            <h3>Dissertation</h3>
            <p>
              I drew from political philosophy, ethics and psychoanalysis to analyse human rights 
              and moral disengagement in the context of <span className='bold'>climate change</span>, 
              receiving a high First grade. 
            </p>
          </div>
          ...
          <div className='text-content'>
            ...
            <p>              
              ...
              taught me adaptability, communication and collaboration skills, and problem-solving skills 
              as applied outside of coding. 
            </p>
            <p>
              The multiple units I took in <span className='bold'>ethics and value theory</span> have 
              taught me how to apply ethical frameworks to problems in society, which will become 
              increasingly relevent to tech workers as A.I. advances.
            </p>
          </div>
        </div>
      </div>
